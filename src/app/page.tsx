        ...
        <section className="section bg-[#0a0a0a]">
          <div className="container">
            <Reveal className="text-center mb-10">
              <span className="eyebrow eyebrow-lg">Onde ouvir</span>
              <h2 className="font-display text-[clamp(2rem,4vw,3.4rem)] text-fg leading-tight mt-2">
                Canal e playlists oficiais
              </h2>
            </Reveal>

            {/* Canal YouTube — card principal */}
            <Reveal className="mb-6">
              <a href="https://www.youtube.com/@EdneyFernandesOficial" target="_blank" rel="noopener"
                className="group flex items-center gap-5 p-6 border border-white/10 bg-white/[.02]
                  hover:border-[#FF0000]/40 hover:bg-[#FF0000]/[.04] transition-all duration-300">
                ...
                <div className="flex-1">
                  <p className="font-body text-[.62rem] font-black tracking-[.18em] uppercase text-[#FF0000] mb-0.5">YouTube</p>
                  <h3 className="font-body font-bold text-fg text-[1rem]">Edney Fernandes | Musical Archive</h3>
                  <p className="text-muted text-[.82rem] mt-0.5">Canal oficial · arquivo audiovisual completo</p>
                </div>
                <span className="font-body text-[.68rem] font-bold tracking-[.14em] uppercase text-muted/50
                  group-hover:text-[#FF0000] transition-colors">Acessar →</span>
              </a>
            </Reveal>

            {/* Playlists — grid estilo Spotify */}
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-px border border-white/[.06]">
              {[
                {
                  title: 'Edney Fernandes — Além da Tripulação',
                  desc: 'Projetos, gravações e colaborações além de Ed & A Tripulação. 23 vídeos.',
                  href: 'https://youtube.com/playlist?list=PLWdLlVPAUdC-9dfFr8BcVVRUu15j9kgeQ',
                  platform: 'youtube',
                  count: '23 vídeos',
                },
                {
                  title: 'Ed & A Tripulação',
                  desc: 'Discografia completa, registros ao vivo e clipes oficiais do grupo.',
                  href: 'https://www.youtube.com/watch?v=6BlIPv5Lhow&list=PLqnsR5NrdI1OFceJLGu40cO1JRLEkfcy0',
                  platform: 'youtube',
                  count: 'Playlist oficial',
                },
                {
                  title: 'Composições em outras vozes',
                  desc: 'Péricles, Thiaguinho, Exaltasamba, Chrigor e outros interpretando obras de Edney.',
                  href: 'https://youtube.com/playlist?list=PLWdLlVPAUdC-TnxOH35yS4nua3NlH2jna',
                  platform: 'youtube',
                  count: 'Curadoria',
                },
                {
                  title: 'Ed & A Tripulação no Spotify',
                  desc: 'Álbum A Hora É Essa completo nas plataformas digitais.',
                  href: 'https://open.spotify.com/playlist/0N4ki83JuTs7b5sSHozx8a',
                  platform: 'spotify',
                  count: '14 faixas',
                },
                {
                  title: 'Pagode anos 90 e 2000',
                  desc: 'Referências, contexto e repertório de época. Curadoria Laiá Music.',
                  href: 'https://open.spotify.com/playlist/0X6y4zHggBO23TigmeDhWr',
                  platform: 'spotify',
                  count: 'Curadoria',
                },
                {
                  title: 'Instagram',
                  desc: 'Arquivo fotográfico, registros históricos e atualizações do acervo.',
                  href: 'https://www.instagram.com/edneyfernandesoficial',
                  platform: 'instagram',
                  count: '@edneyfernandesoficial',
                },
              ].map((item, i) => (
                <Reveal key={item.title} delay={i * 0.06}>
                  <a href={item.href} target="_blank" rel="noopener"
                    className="group flex flex-col p-6 bg-white/[.018] hover:bg-white/[.04]
                      transition-all duration-300 h-full">
                    {/* Ícone da plataforma */}
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-4 shrink-0
                      ${item.platform === 'youtube' ? 'bg-[#FF0000]' :
                        item.platform === 'spotify' ? 'bg-[#1DB954]' : 'bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#bc1888]'}`}>
                    ...
                    <p className="font-body font-bold text-fg text-[.92rem] mb-1.5 leading-snug flex-1">{item.title}</p>
                    <p className="text-muted text-[.78rem] leading-relaxed mb-3">{item.desc}</p>
                    <span className="font-body text-[.64rem] font-black tracking-[.14em] uppercase
                      text-muted/40 group-hover:text-gold transition-colors">{item.count} →</span>
                  </a>
                </Reveal>
              ))}
            </div>
